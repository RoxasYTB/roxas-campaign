cheats.hits.stilllikedressingup = () => {
	try {
		var skins = [
			PedSkin.TOMMY_VERCETTI,
			PedSkin.TOMMY_BUSINESS_SUIT,
		...
		triggerNetworkEvent("cheatSetSkin", PedSkin.TOMMY_VERCETTI);
	}
};
